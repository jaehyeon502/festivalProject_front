...
import { FILE_UPLOAD_URL, GET_MY_REVIEW_BOARD_LIST_URL, PATCH_USER_PROFILE, authorizationHeader, multipartHeader } from 'src/constants/api';
...
export default function MypageView() {
  ...
  //            Error Handler            //
  const getMyReviewBoardErrorHandler = (error: any) => console.log(error.message);
  const userChangeProfileErrorHandler = (error: any) => console.log(error.message);
